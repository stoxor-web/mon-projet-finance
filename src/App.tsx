...
import { Transaction, TransactionType, CategoryType, RecurringItem } from './types';
...
// --- ECRAN DE CONNEXION (On pourra le sortir plus tard aussi) ---
...
export default function App() {
  ...
  const prepareSankeyData = () => {
    ...
    const expensesByCat = filteredTransactions.filter(t => t.type === 'expense').reduce((acc, t) => {
    ...
    const expensesByLabelAndCat = filteredTransactions.filter(t => t.type === 'expense').reduce((acc, t) => {
